    ...
    if (!visit) {
      ...
      const table = {
        ...
        headers: [
          ...
          { label: "Gimimo data", property: 'birthday', width: 80, renderer: null},
          { label: 'Parašas', property: 'signature', width: 80, renderer: (value: any, indexColumn: any, indexRow: any, row: any, rectRow: any, rectCell: any) => {
            const { x, y } = rectCell;
            doc.image(value, x, y, { fit: [50, 30], align: 'center', valign: 'center'});
          }},
          { label: "Dokumentas", property: 'idType', width: 80, renderer: null},
      ...
      await doc.table(table, {
        ...
        prepareRow: async (row: any, indexColumn: any, indexRow: any, rectRow: any, rectCell: any) => {
      ...
      doc.table(table, {
        ...
        prepareRow: (row: any, indexColumn: any, indexRow: any, rectRow: any) => doc.font("Helvetica").fontSize(8),
      });
